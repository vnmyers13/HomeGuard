...
from playwright.executor import PlaybookExecutor
from playwright.models import (
    HealthResponse,
    JobListResponse,
    JobResult,
    JobState,
...
from playwright.pool import get_pool, shutdown_pool
...
async def _run_job(job_state: JobState):
    ...
    try:
        ...
        from playwright.executor import PlaybookStep
        ...
        # Build step results
        from playwright.models import ActionType, StepResult
...
app = FastAPI(
    title="HomeGuard Playwright Executor",
...
if __name__ == "__main__":
    ...
    uvicorn.run("playwright.main:app", host="0.0.0.0", port=8002, reload=True)